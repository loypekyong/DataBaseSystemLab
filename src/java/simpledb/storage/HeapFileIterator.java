...
public class HeapFileIterator implements DbFileIterator { 
    ...
    public void open() throws DbException, TransactionAbortedException {
        currentPage = 0;
        HeapPageId heapPageId = new HeapPageId(heapFile.getId(), currentPage); 
        ...
        currentIterator = heapPage.iterator(); 
    ...
    public boolean hasNext() throws DbException, TransactionAbortedException {
        ...
        currentPage++;
        if (currentPage < BufferPool.numPages) {    
            HeapPageId heapPageId = new HeapPageId(heapFile.getId(), currentPage); 
    ...
    //     currentPageNumber++; 
    //     if (currentPageNumber < BufferPool.numPages()) { 
    //         HeapPageId heapPageId = new HeapPageId(heapFile.getId(), currentPageNumber); 
